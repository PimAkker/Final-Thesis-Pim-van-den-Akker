...
class CocoDataset():
    ...
    def display_image(self, image_id, show_polys=True, show_bbox=True, show_crowds=True, use_url=False):
        ...
        image = PILImage.fromarray(np.load(image_path))
        ...
        html += '<div class="svgclass"><svg width="{}" height="{}">'.format(adjusted_width*2, adjusted_height*2)
...
import importlib
annotation_path = r'C:\Users\pimde\OneDrive\thesis\Blender\annotations.json'
image_dir = r'C:\Users\pimde\OneDrive\thesis\Blender\blender_python_code\data\-inst-Prior1_inst.npy'
...
html = coco_dataset.display_image(1, use_url=False, show_polys=True, show_bbox=False)
